...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Refresh official ADR 05 Pinot evidence in one pass.")
...
def main() -> None:
    ...
    print(f"Refreshed {len(manifest['artifacts'])} official Pinot evidence artifacts.")
